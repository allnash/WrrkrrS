...
public class GoogleAuthenticator {
    ...
    public static boolean validateTOTPCode(String TOTPCode, String TOTPKey) {
        // WARN: REMOVE THIS CODE BELOW IF NEEDED.
        if (Utils.isDebugMode()) {
            Logger.warn("Debug mode - TOTP will not be validated for user");
            if (TOTPCode.equals("234567")) {
                return true;
            } else {
                return false;
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String barCode = getGoogleAuthenticatorBarCode(secretKey, "test@example.com", "OmegaTrace Inc.");
